...
export default function HouseholdSettings() {
  ...
  return (
    <>
      ...
      <style>{`
        /* Larger slider thumb for better UX */
        ...
        .slider-large::-webkit-slider-thumb:active {
        ...
        .slider-large::-moz-range-thumb:active {
          transform: scale(1.05);
        }
      `}</style>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-6">
              {/* Slider Container with matching width */}
              <div className="flex-1">
                <input
                  ...
                  className="slider-large w-full h-3 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-green-600"
                  style={{
                    background: `linear-gradient(to right, #16a34a 0%, #16a34a ${((householdSize - 1) / 9) * 100}%, #e5e7eb ${((householdSize - 1) / 9) * 100}%, #e5e7eb 100%)`
                  }}
                />
                
                {/* Scale Markers - Slightly narrower to account for slider thumb */}
              ...
              {/* Number Display */}
              <div className="flex flex-col items-center justify-center w-24 h-24 bg-green-50 border-2 border-green-600 rounded-lg flex-shrink-0">
